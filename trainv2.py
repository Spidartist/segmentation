...
def train(train_loader, 
          ...
          writer,
          args):
    # model.load_state_dict(torch.load("/mnt/quanhd/DoAn/unet/segmentation/work_dirs/ijepa-adapter-base-upernet-v2/20240611_183740/snapshots/19.pth")['state_dict'])
